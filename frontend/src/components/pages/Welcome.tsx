  ...
  return (
    <div className='welcome__banner'>
          ...
          <div className='screens'>
            ...
            <p className='screens__p'>Stream your favorite movies and TV shows <br /> on your phone, tablet, laptop, and TV.</p>
            </div>
            <div>
              <img className='screens__img' src="./assets/screens.png" alt="phone, pc and tablet screens" />
              </div>
          </div>
